# Bioinformatics Coursework Portfolio: Biological Databases (BIMM/BENG/CSE 182)
...
- HW1 - Fasta File Processing: Read biological sequence files, report sequence lengths, filter proteins by species and build indexes to look up sequences.
- HW2 - Sequence Alignment and Gap Penalties: Use dynamic programming to align DNA sequences, study how scoring choices affect alignment lengths and reduce memory use when working with longer sequences.
- HW3 - DNA Pattern Matching: Search DNA for multiple patterns using a trie, estimate matches expected by chance and explore the tradeoff between approaches in terms of search speed and sensitivity (percentage of true matches correctly identified).
- HW4 - CpG Islands and Evolutionary Trees: Compare observed and expected DNA base-pair frequencies, use Markov models to predict CpG islands and check whether genetic variants fit a perfect evolutionary tree. Measure how the tree-checking program's running time changes with input size.
